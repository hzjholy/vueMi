<template>
    <div class="life">
        <div>
            <div v-if="lifedata[0]!== undefined">
                <van-row class="home-sale">
                    <van-col span="12" class="col-box" v-for="(item,index) in lifedata" @click.native="goState({name:'Detail',params: {pid: item.id}})">
...
export default {
    ...
    mounted() {
        // 获取api数据
        // 获取家电数据
        this.$store.dispatch('getLifedata')
    },
    computed: {
        ...mapState(['lifedata']),
    }

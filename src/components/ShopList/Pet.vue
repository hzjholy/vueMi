<template>
    <div class="pet">
        <div>
            <div v-if="petdata[0]!== undefined">
                <van-row class="home-sale">
                    <van-col span="12" class="col-box" v-for="(item,index) in petdata" @click.native="goState({name:'Detail',params: {pid: item.id}})">
...
export default {
    ...
    mounted() {
        // 获取api数据
        // 获取家电数据
        this.$store.dispatch('getPetdata')
    },
    computed: {
        ...mapState(['petdata']),
    }
